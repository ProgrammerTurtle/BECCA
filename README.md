...
This is a fully custom L1 Certification rocket that:
...
The avionics bay also features a custom recovery GPS device, which uses a Particle Boron paired with an Adafruit Ultimate GPS Featherwing to provide GPS coordinates of the landed rocket for easy recovery.  

BOM can be found in the DesignFiles folder as a .csv, but is also viewable here: https://docs.google.com/spreadsheets/d/13uqdfzb-miqL_V5Jl5AkuYBnuj3rxMHTL2oK4_T52Ag/edit?usp=sharing
***
